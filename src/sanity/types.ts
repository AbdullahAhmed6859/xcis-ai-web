...
export type AllTrainingsSection = {
...
export type AllCaseStudiesSection = {
...
export type StructuredStepsSection = {
...
export type ImpactCardsSection = {
...
export type AllSanitySchemaTypes = Training | BlockContent | Slug | Faq | Job | CtaSection | CompanySlideshowSection | CertificationsSection | Certification | SanityImageCrop | SanityImageHotspot | CompaniesSection | ContactFormSection | Team | AllTrainingsSection | AllJobsSection | AllTeamMembersSection | AllMediaSection | AllCaseStudiesSection | CarouselSection | ReviewsSection | LocationsSection | MediaSection | TrainingsSection | StructuredStepsSection | ImpactCardsSection | ImpactSection | CaseStudiesSection | ServicesSection | HeroSection | ImpactStatistic | Location | Service | Media | CaseStudy | TeamMember | Review | TrustedCompany | Seo | SiteSettings | SplitImageSection | Features | PageBuilder | Page | Category | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
export declare const internalGroqTypeReferenceTo: unique symbol;
// Source: ./src/sanity/lib/queries.ts
// Variable: PAGE_QUERY
// Query: *[_type == "page" && slug.current == $slug][0]{  "slug": slug.current,  "seo": {    "title": coalesce(seo.title, title, ""),    "description": coalesce(seo.description,  ""),    "image": seo.image,    "noIndex": seo.noIndex == true  },  "content": content[hide != true]{    ...,    // Logic for the Impact Section    _type == "impactSection" => {        "countMembers": count(*[_type == "teamMember"]),        "teamMembers": teamMembers[defined(@)]->{          name,          image        },        statistics[]{          heading,          highlightedHeading,          text        }      },    // Logic for Case Studies    _type == "caseStudiesSection" => {      "caseStudies": caseStudies[defined(@)]->{        title,        excerpt,        mainImage,        "slug": slug.current,        "services": services[]->title      }    },    _type == "allCaseStudiesSection" => {      "caseStudies": *[_type == "caseStudy"]{        title,        excerpt,        mainImage,        "slug": slug.current,        "services": services[]->title      },      "services": *[_type == "service"].title    },    _type == "allMediaSection" => {      "media": *[_type == "media"]{        title,        mainImage,        "slug": slug.current,        readTime,        publishedAt,        author->{          name,          image        },        "categories": categories[]->title      },      "categories": *[_type == "category"].title    },    _type == "allTeamMembersSection" => {      "teamMembers": *[_type == "teamMember"]| order(name asc){        name,        image,        bio,        "teams":teams[]->title      },      "teams": teams[]->title    },    _type == "allJobsSection" => {      "jobs": *[_type == "job"]{        title,        "slug": slug.current,        department->,        postedAt,        schedule,        applicationLink,        description      },    },    _type == "allTrainingsSection" => {      "trainings": *[_type == "training"]{        title,        "slug": slug.current,        publishedAt,        description      },    },    _type == "servicesSection" => {      services[]->{        title,        description,        "slug": slug.current,        icon      }    },    _type == "heroSection" => {      companies[]->{        name,        logo      }    },    _type == "companySlideshowSection" => {      companies[]->{        name,        logo      }    },    _type == "companiesSection" => {      companies[]->{        name,        website,        logo      }    },    _type == "reviewsSection" => {      reviews[]->{        name,        image,        reviewText,        position      }    },    _type == "locationsSection" => {      locations[]->{        image,        name,        slug      }    },    _type == "mediaSection" => {      media[]->{        title,        mainImage,        "slug": slug.current,        readTime,        publishedAt,        author->{          name,          image        },        "categories": categories[]->title      }    }  }}
...
// Query: *[_id == "siteSettings"][0]{  ...,  homePage->{  "slug": slug.current,  "seo": {    "title": coalesce(seo.title, title, ""),    "description": coalesce(seo.description,  ""),    "image": seo.image,    "noIndex": seo.noIndex == true  },  "content": content[hide != true]{    ...,    // Logic for the Impact Section    _type == "impactSection" => {        "countMembers": count(*[_type == "teamMember"]),        "teamMembers": teamMembers[defined(@)]->{          name,          image        },        statistics[]{          heading,          highlightedHeading,          text        }      },    // Logic for Case Studies    _type == "caseStudiesSection" => {      "caseStudies": caseStudies[defined(@)]->{        title,        excerpt,        mainImage,        "slug": slug.current,        "services": services[]->title      }    },    _type == "allCaseStudiesSection" => {      "caseStudies": *[_type == "caseStudy"]{        title,        excerpt,        mainImage,        "slug": slug.current,        "services": services[]->title      },      "services": *[_type == "service"].title    },    _type == "allMediaSection" => {      "media": *[_type == "media"]{        title,        mainImage,        "slug": slug.current,        readTime,        publishedAt,        author->{          name,          image        },        "categories": categories[]->title      },      "categories": *[_type == "category"].title    },    _type == "allTeamMembersSection" => {      "teamMembers": *[_type == "teamMember"]| order(name asc){        name,        image,        bio,        "teams":teams[]->title      },      "teams": teams[]->title    },    _type == "allJobsSection" => {      "jobs": *[_type == "job"]{        title,        "slug": slug.current,        department->,        postedAt,        schedule,        applicationLink,        description      },    },    _type == "allTrainingsSection" => {      "trainings": *[_type == "training"]{        title,        "slug": slug.current,        publishedAt,        description      },    },    _type == "servicesSection" => {      services[]->{        title,        description,        "slug": slug.current,        icon      }    },    _type == "heroSection" => {      companies[]->{        name,        logo      }    },    _type == "companySlideshowSection" => {      companies[]->{        name,        logo      }    },    _type == "companiesSection" => {      companies[]->{        name,        website,        logo      }    },    _type == "reviewsSection" => {      reviews[]->{        name,        image,        reviewText,        position      }    },    _type == "locationsSection" => {      locations[]->{        image,        name,        slug      }    },    _type == "mediaSection" => {      media[]->{        title,        mainImage,        "slug": slug.current,        readTime,        publishedAt,        author->{          name,          image        },        "categories": categories[]->title      }    }  }}}
...
// Query: *[_type == "caseStudy" && slug.current == $slug][0]{  _id,  title,  body,  mainImage,  publishedAt,  excerpt,  "services": coalesce(    services[]->{      _id,      "slug": slug.current,      title    },    []  ),  author->{    name,    image  },  relatedCaseStudies[]{    _key, // required for drag and drop    ...@->{_id, title, slug} // get fields from the referenced post  }}
...
// Query: *[_type == "media" && slug.current == $slug][0]{  _id,  title,  body,  mainImage,  publishedAt,  excerpt,  "categories": categories[]->title,  author->{    name,    image  },  relatedMedia[]{    _key, // required for drag and drop    ...@->{_id, title, slug} // get fields from the referenced post  }}
...
// Query: *[_type == "service" && slug.current == $slug][0]{  "slug": slug.current,  title,  icon,  description,  companies[]->{    name,    logo  },  faqs[]->{    body,    title  },}
