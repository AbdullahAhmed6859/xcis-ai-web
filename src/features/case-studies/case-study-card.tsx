...
export function CaseStudyCard(props: CASE_STUDIES_QUERYResult[0]) {
  const { title, author, mainImage, publishedAt, services } = props;

  return (
    <Link className="group" href={`/case-studies/${props.slug!.current}`}>
