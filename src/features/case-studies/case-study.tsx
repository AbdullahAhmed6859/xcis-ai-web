...
export function CaseStudy(props: NonNullable<CASE_STUDY_QUERYResult>) {
  ...
  return (
    <article className="min-h-screen bg-white">
      {/* HERO SECTION
       */}
      <div className="relative h-[60vh] min-h-125 w-full bg-dark-blue overflow-hidden">
        {/* Background Image */}
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-linear-to-t from-dark-blue via-dark-blue/70 to-transparent" />
